const DUMMY_DATA = [
  {
    ...
    description:"جراح و عضو هیئت علمی دانشگاه علوم پزشکی شیراز است.او نخستین پیوند کبد در ایران از فرد زنده به زنده را انجام داد و به عنوان پدر پیوند کبد در ایران شناخته می‌شود. ملک‌حسینی انجام‌دهنده نخستین پیوند کبد در ایران، نخستین پیوند کبد از فرد زنده به فرد زنده در ایران و نخستین پیوند از یک کبد به دو نفر و همچنین بنیانگذار بخش پیوند اعضا بیمارستان نمازی و بیمارستان پیوند اعضا ابوعلی سینا است."
  }
  ,
  {
    id: "fig2",
  ...
  },
  {
    ...
    description:"معمار، مرمت‌گر، استاد دانشگاه، چهره ماندگار عرصه معماری، حفاظت و مرمت بناهای تاریخی ایران و عضو پیوسته فرهنگستان هنر جمهوری اسلامی ایران بود.او به عنوان بنیان‌گذار مرمت علمی بناها، محوطه‌ها و بافت‌های تاریخی در ایران و از بنیان‌گذاران سازمان میراث فرهنگی کشور شناخته میشود."
  },
  {
    id:"fig5",
    title:"مرتضی سهرابی",
    ...
    dead:"",
    description:"استاد مهندسی شیمی و به عنوان چهرهٔ ماندگار رشتهٔ مهندسی شیمی در سال ۱۳۸۰ برگزیده شد. دکتر مرتضی سهرابی از اعضای پیوسته فرهنگستان علوم جمهوری اسلامی ایران بود."
  },
  {
    id: "fig3",
